...
### 🟩  devsheke's arkenfox user.js

[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)

This is my fork of `arkenfox user.js` which aims to provide as much privacy and enhanced security as possible, and to reduce tracking and fingerprinting as much as possible - while minimizing any loss of functionality and breakage (but it will happen).
...
### 🟥  acknowledgments
The [arkenfox](https://github.com/arkenfox/user.js) source repository, literally thousands of sources, references and suggestions. Many thanks, and much appreciated.
